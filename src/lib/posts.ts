...
export const POSTS: Post[] = [
  {
    ...
    excerpt: "Triết lý giáo dục của WiT phân biệt rõ 'thầy cô' và 'minh sư' — hai vai trò tưởng giống mà khác hẳn. Ranh giới đó cũng chính là ranh giới AI không bao giờ vượt qua được.",
    date: "2026-09-07",
    content: [
      "Có một cách phân biệt vai trò khá thú vị trong triết lý giáo dục của WiT, gọi là \"9 dạng người trong 1\" — trong đó hai vai gần với nghề giáo nhất là Thầy cô và Minh sư. Nghe qua tưởng giống nhau, nhưng ranh giới giữa hai vai này lại chính là ranh giới mà AI không bao giờ vượt qua được.",
